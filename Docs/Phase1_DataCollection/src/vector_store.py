...
from src.phase1.config import CHROMA_COLLECTION_NAME, CHROMA_PERSIST_DIR
from src.phase1.embeddings import generate_embeddings
...
def query_similar(query_text: str, n_results: int = 5, where: dict = None) -> dict:
    ...
    from src.phase1.embeddings import generate_single_embedding
    collection = get_or_create_collection()
